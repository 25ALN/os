...
CC=gcc-4.6
LD=ld
LIB= -I lib/ -I kernel/ -I device/ -I thread/ -I userprog/ -I fs/ -I lib/kernel/ -I lib/user/
ASFLAGS= -f elf
...
OBJS=$(BUILD_DIR)/main.o $(BUILD_DIR)/init.o \
	...
	$(BUILD_DIR)/print.o $(BUILD_DIR)/switch.o $(BUILD_DIR)/string.o $(BUILD_DIR)/bitmap.o \
	$(BUILD_DIR)/memory.o $(BUILD_DIR)/dubug.o $(BUILD_DIR)/thread.o $(BUILD_DIR)/list.o	\
	$(BUILD_DIR)/console.o $(BUILD_DIR)/sync.o $(BUILD_DIR)/keyboard.o $(BUILD_DIR)/ioqueue.o	\
	$(BUILD_DIR)/tss.o $(BUILD_DIR)/process.o $(BUILD_DIR)/syscall.o $(BUILD_DIR)/syscall_init.o	\
...
.PHONY:mk_dir clean build all boot	#定义了5个伪目标
mk_dir:
